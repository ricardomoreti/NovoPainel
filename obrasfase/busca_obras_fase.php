          ...
          <div class="title_left">
            ...
            <div class="title_right">
              <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <a class="btn btn-app" href="cadastra_obras_fase.php">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Listando Fases da Obra<small>Filtros para pesquisa</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="form_busca" method="get" action="busca_obras_fase.php" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <tbody>
                          ...
                          <?php
                            ...
                            if($Descricao == ''){
                              ...
                              $CriterioDescricao = "AND OBF.Descricao LIKE '%".$Descricao."%' ";
                            }

                            if($Status == ''){
                              $CriterioStatus = '';
                            } else {
                              $CriterioStatus = "AND OBF.Status = ".$Status;
                            }
                            ...
                            $sqlRead = "SELECT * 
                                        FROM tb_obras_fase OBF ".$Criterios;
                              try {
                          ...
                          <tr class="even pointer">
                            <td class=" "><?php echo $rs->IdObraFase; ?></td>
                            <td class=" "><?php echo $rs->Descricao; ?></td>
                            <td class=" last">                              
                                <a href="editar_obras_fase.php?IdObraFase=<?php echo $rs->IdObraFase; ?>">
                                  <i class="fa fa-edit"></i> Editar
                                </a> | 
                                <a href="cadastra_obras_fase.php?acao=excluir&IdObraFase=<?php echo $rs->IdObraFase; ?>" onclick="return confirm('Deseja excluir?');">
