<?php
      ...
      if($acao == 'inserir'){
        ...
        $sql  = 'INSERT INTO tb_obras_fase (    Descricao, 
                                                Status,
                                                DtInclusao) ';
        ...
        try {
          ...
          if($create->execute()){
            ...
            echo "<script>window.location = 'busca_obras_fase.php?Status=1';</script>";
          }
      ...
      if($acao == 'editar'){
        ...
        $IdObraFase  = $_POST['IdObraFase'];
        $Descricao = removeAcentos(transformaMaiuscula($_POST['Descricao']));
        $Status = $_POST['Status'];
        $DtAlteracao = converteDataHora($_POST['DtAlteracao']);

        $sqlUpdate = 'UPDATE tb_obras_fase 
                      SET IdObraFase = :IdObraFase, 
                          Descricao = :Descricao, 
                          Status = :Status,
                          DtAlteracao = :DtAlteracao
                      WHERE IdObraFase = :IdObraFase';
        ...
        try {
          ...
          $update->bindValue(':IdObraFase', $IdObraFase, PDO::PARAM_INT);
          if($update->execute()){
      ...
      if($acao == 'excluir'){
        ...
        $sqlDelete = 'DELETE FROM tb_obras_fase WHERE IdObraFase = :IdObraFase';

        try {
          $delete = $db->prepare($sqlDelete);
          $delete->bindValue(':IdObraFase', $IdObraFase, PDO::PARAM_INT);
          if($delete->execute()){
          ...
          <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <a href="cadastra_obras_fase.php">
                    <a class="btn btn-app" href="busca_obras_fase.php">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cadastro de Fases da Obra</h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="cadastro_obras_fases" method="post" action="" data-parsley-validate class="form-horizontal form-label-left">
