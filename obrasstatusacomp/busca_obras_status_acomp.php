          ...
          <div class="title_left">
            ...
            <div class="title_right">
              <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <a class="btn btn-app" href="cadastra_obras_status_acomp.php">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Listando Status de Acompanhamento<small>Filtros para pesquisa</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="form_busca" method="get" action="busca_obras_status_acomp.php" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Status da Obra</th>
                            <th class="column-title">Status Final?</th>
                        ...
                        <tbody>
                          ...
                          <?php
                            ...
                            if($Descricao == ''){
                              ...
                              $CriterioDescricao = "AND OBSA.Descricao LIKE '%".$Descricao."%' ";
                            }

                            if($Status == ''){
                              $CriterioStatus = '';
                            } else {
                              $CriterioStatus = "AND OBSA.Status = ".$Status;
                            }
                            ...
                            $sqlRead = "SELECT * 
                                        FROM tb_obras_status_acomp OBSA ".$Criterios;
                              try {
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" last">                              
                                ...
                                <a href="cadastra_obras_status_acomp.php?acao=excluir&IdObraStatus=<?php echo $rs->IdObraStatus; ?>" onclick="return confirm('Deseja excluir?');">
