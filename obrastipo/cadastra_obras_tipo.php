<?php
      ...
      if($acao == 'inserir'){
        ...
        $sql  = 'INSERT INTO tb_obras_tipo (    Descricao, 
                                                Status,
                                                DtInclusao) ';
        ...
        try {
          ...
          if($create->execute()){
            ...
            echo "<script>window.location = 'busca_obras_tipo.php?Status=1';</script>";
          }
      ...
      if($acao == 'editar'){
        ...
        $IdObraTipo  = $_POST['IdObraTipo'];
        $Descricao = removeAcentos(transformaMaiuscula($_POST['Descricao']));
        $Status = $_POST['Status'];
        $DtAlteracao = converteDataHora($_POST['DtAlteracao']);

        $sqlUpdate = 'UPDATE tb_obras_tipo 
                      SET IdObraTipo = :IdObraTipo, 
                          Descricao = :Descricao, 
                          Status = :Status,
                          DtAlteracao = :DtAlteracao
                      WHERE IdObraTipo = :IdObraTipo';
        ...
        try {
          ...
          $update->bindValue(':IdObraTipo', $IdObraTipo, PDO::PARAM_INT);
          if($update->execute()){
      ...
      if($acao == 'excluir'){
        ...
        $sqlDelete = 'DELETE FROM tb_obras_tipo WHERE IdObraTipo = :IdObraTipo';

        try {
          $delete = $db->prepare($sqlDelete);
          $delete->bindValue(':IdObraTipo', $IdObraTipo, PDO::PARAM_INT);
          if($delete->execute()){
          ...
          <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                <a href="cadastra_obras_fase.php">
                    <a class="btn btn-app" href="busca_obras_tipo.php">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cadastro de Tipos de Obra</h2>
